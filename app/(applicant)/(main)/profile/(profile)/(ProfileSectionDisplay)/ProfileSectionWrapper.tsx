...
export default function ProfileSectionWrapper({
    ...
    return (
        <div
            id={id}
            className="w-full max-w-[974px] px-4 md:px-6 pt-6 flex flex-col items-center"
        >
            <div className="w-full">
                <div className="flex justify-between items-center mb-4">
                    ...
                    <button
                        onClick={onEdit}
                        className="p-2 hover:bg-gray-100 rounded-full transition-all active:scale-95 cursor-pointer shrink-0"
                    >
